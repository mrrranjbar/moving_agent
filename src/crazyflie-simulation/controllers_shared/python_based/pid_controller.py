...
class pid_velocity_fixed_height_controller():
    ...
    def pid(self, dt, desired_vx, desired_vy, desired_yaw_rate, desired_altitude, actual_roll, actual_pitch, actual_yaw_rate,
        ...
        # mrr
        # print("MRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR")
        # simulation
        gains = {"kp_att_y": 1, "kd_att_y": 0.5, "kp_att_rp": 0.5, "kd_att_rp": 0.1,
                 "kp_vel_xy": 2, "kd_vel_xy": 0.5, "kp_z": 10, "ki_z": 5, "kd_z": 5}
        # real drone
        # gains = {"kp_att_y": 6, "kd_att_y": 0.35, "kp_att_rp": 6, "kd_att_rp": 0,
        #           "kp_vel_xy": 25, "kd_vel_xy": 0, "kp_z": 2, "ki_z": 0.5, "kd_z": 0}
        # last stable
        # gains = {"kp_att_y": 1.5, "kd_att_y": 0.45, "kp_att_rp": 0.6, "kd_att_rp": 0.08,
        #          "kp_vel_xy": 3, "kd_vel_xy": 0.45, "kp_z": 9, "ki_z": 4.5, "kd_z": 4.5}
        
        # gains = {"kp_att_y": 1.6, "kd_att_y": 0.45, "kp_att_rp": 0.7, "kd_att_rp": 0.08,
        #          "kp_vel_xy": 3.5, "kd_vel_xy": 0.45, "kp_z": 8.6, "ki_z": 4.4, "kd_z": 4.3}
        ...
        # Motor mixing
        # print(f"actual_roll={actual_roll}, actual_pitch={actual_pitch}")
