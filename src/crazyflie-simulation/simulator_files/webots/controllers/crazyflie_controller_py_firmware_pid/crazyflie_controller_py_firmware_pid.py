...
sys.path.append('/usr/lib/python3.8/site-packages/cffirmware-1.0-py3.8-linux-x86_64.egg')
import cffirmware
...
while robot.step(timestep) != -1:
    ...
    print("....................................")
    print(f"cmd_roll: {cmd_roll}")
    print(f"cmd_pitch: {cmd_pitch}")
    print(f"cmd_yaw: {cmd_yaw}")
    print(f"cmd_thrust: {cmd_thrust}")
