...
def ros_init():
    ...
    rospy.Subscriber("forward_desired", String, forward_desired_callback)

forward_desired = 0
def forward_desired_callback(data):
    global forward_desired
    rospy.loginfo(rospy.get_caller_id() + "action= %s", data.data)
    forward_desired = float(data.data)
...
if __name__ == '__main__':
    ...
    while robot.step(timestep) != -1 and not rospy.is_shutdown():
        ...
        # print(f"m1={-motor_power[0]}, m2={motor_power[1]}, m3={-motor_power[2]}, m4={motor_power[3]}")
